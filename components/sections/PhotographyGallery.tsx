...
export default function PhotographyGallery() {
  ...
  return (
    <>
      {/* Section Intro */}
      <section className="w-full bg-darkGreen pt-20 pb-8 px-6 md:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <p className="font-syncopate text-xs tracking-widest uppercase" style={{ color: '#c9a227' }}>
            THE WORK
          </p>
          <h2 className="font-cormorant-garamond italic font-bold text-4xl mt-3" style={{ color: '#fcfbf7' }}>
            Every frame, a story.
          </h2>
          <p className="font-cormorant-garamond text-lg mt-2" style={{ color: 'rgba(252, 251, 247, 0.6)' }}>
            Browse by session type or explore the full portfolio.
          </p>
        </div>
      </section>

      {/* Filter Bar */}
      <section className="w-full bg-darkGreen border-t border-gold/20 border-b border-gold/20">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 pt-10 pb-6">
          <div className="flex gap-10 font-sans text-[10px] tracking-[0.3em] uppercase overflow-x-auto pb-2">
