...
export default function PhotographyGallery() {
  ...
  return (
    <>
      {/* Portfolio Section - Intro, Filters, and Gallery */}
      <section className="w-full bg-darkGreen px-6 md:px-12 lg:px-20 pt-20 pb-16 md:pb-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 pb-6 border-b border-gold/20">
            <div className="flex gap-8 font-sans text-[10px] tracking-[0.3em] uppercase overflow-x-auto">
