...
const projects: Project[] = [
  {
    ...
    alt: 'Tarro Law Group website interface designed by FemStudio',
  },
  {
    ...
    alt: 'Business website design example by FemStudio for a professional service brand',
  },
  {
    ...
    year: '2024',
    image: '/images/webdesign/client-website-example.jpg',
    alt: 'Landing page design example by FemStudio for lead generation and service inquiries',
  },
  {
    ...
    alt: 'FemStudio web design portfolio preview with dark green and gold brand styling',
  },
  {
    title: 'Commerce Direction',
    category: 'E-COMMERCE',
    year: '2024',
    image: '/images/webdesign/tarro-law-group-website-design.jpg',
    alt: 'E-commerce website direction showing structured product and service page design',
  },
  {
    title: 'FemStudio',
    category: 'WEB DESIGN',
    ...
    alt: 'FemStudio website design preview for the Houston photography and web design studio',
  },
]
